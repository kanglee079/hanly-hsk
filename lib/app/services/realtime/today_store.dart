...
///
/// HYBRID APPROACH:
/// - Uses server data for authoritative info (streak, queues, stats)
/// - Reduced polling frequency (5 min instead of 15 sec)
/// - LocalProgressService handles learning progress locally
/// - Server sync is background, non-blocking
